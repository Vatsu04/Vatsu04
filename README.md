...
- 🖥️ Cientista da Computação Formado
- 🎓 Mestrando em Informática — PUC-Rio (ênfase em Sistemas de Computação)
- 🔧 Técnico em Informática formado no SENAC


## 🚀 No que estou trabalhando

- 🛒 **TAScloner** & **Bamboolites** — duas lojas virtuais sobre um backend Spring Boot compartilhado, com pagamentos via Mercado Pago e frete via Melhor Envio
- 👁️ **VigIA Brasil** — sistema de IA para segurança pública com curadoria de câmeras e detecção de objetos (armas, brigas), incluindo um plano de implantação em Niterói
- 🌱 **Dissertação de mestrado** — IA aplicada ao agronegócio para detecção de pragas, com Machine Learning, Deep Learning e YOLO
